...
public class TestDB
{
    ...
    public static void main( String [] args )
    {
        ...
        // need to do initial load before doing anything else. If you don't
        // you'll get an
        ...
        System.out.println( "************" );
        Appointment newAppt = new Appointment( "800", java.sql.Date.valueOf( "2009-09-01" ),
                java.sql.Time.valueOf( "10:15:00" ) );
        // extra steps here due to persistence api and join, need to create
        // objects in list
        ...
        System.out.println( "" );
        Patient newObj = new Patient( "260", "whatever", "123 Main", 'y',
                java.sql.Date.valueOf( "1962-12-19" ) );
        ...
        newObj = new Patient( "250", "whatever", "123 Main", 'y',
                java.sql.Date.valueOf( "1962-12-19" ) );
        db.addData( newObj );
        ...
        // int numRows =
        // db.doUpdInsDel("insert/update or delete free form query");
